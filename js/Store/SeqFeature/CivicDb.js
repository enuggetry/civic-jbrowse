  ...
  */
{
    constructor: function( args ) {
        console.log("CIVICDB plugin");

        window.civic.createStream('https://civicdb.org/api/variants?count=1000');

        this.data = args.blob ||
            new XHRBlob( this.resolveUrl(
                //this._evalConf('https://civicdb.org/api/variants?count=200')
    ...
    _loadFeatures() {
        ...
        window.civicstream.pipe(parseStream);
